    ...
    do {
        ...
        if (input.inputNumber > 0 && input.inputNumber < 11) {
            if (randomNumber === input.inputNumber) {
                ...
                console.log(chalk.blueBright(`Your guess is too low. ${counter} attempts remaining`));
                counter--;
            }
            else if (randomNumber < input.inputNumber) {
                console.log(chalk.blueBright(`Your guess is too high. ${counter} attempts remaining`));
                counter--;
            }
        }
        else {
